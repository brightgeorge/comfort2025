...
from branch1app.models import table1,in_exp_items_daily,opening_balance,category,ledger,accounts_book,background_color,share_holders
...
def view_all_category1(request):
...
def create_new_category1(request):
    if 'username' in request.session:
...
def regi_new_category1(request):
    if 'username' in request.session:
...
def delete_category1(request,id):
    if 'username' in request.session:
...
def view_all_category_delete1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/creater_master/category/view_all_category_delete.html',context)
    return render(request, 'index.html')
...
def view_all_items_delete1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/creater_master/items/view_all_items_delete.html',context)
    return render(request, 'index.html')
...
def create_new_ledger1(request):
    if 'username' in request.session:
...
def regi_multiple_new_ledger1(request):
    if 'username' in request.session:
        ledger_name = request.POST.get('ledger_name')
        contact_person_name = request.POST.get('contact_person_name')
        contact_person_number = request.POST.get('contact_person_number')
...
def view_all_ledger_delete1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/creater_master/ledger/view_all_ledger_delete.html',context)
    return render(request, 'index.html')
...
def view_all_accounts_book1(request):
    if 'username' in request.session:
...
def create_new_accounts_book1(request):
    if 'username' in request.session:
...
def regi_new_accounts_book1(request):
    if 'username' in request.session:
...
def regi_multiple_new_accounts_book1(request):
    if 'username' in request.session:
        accounts_book_name = request.POST.get('accounts_book_name')
...
def delete_accounts_book1(request,id):
    if 'username' in request.session:
...
def update_accounts_book1(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            accounts_book_name = request.POST.get('accounts_book_name')
...
def view_all_accounts_book_delete1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/creater_master/accounts_book/view_all_accounts_book_delete.html',context)
    return render(request, 'index.html')
...
def in_exp_items_entry1(request):
    if 'username' in request.session:
...
def reg_in_exp_items_entry1(request):
    if 'username' in request.session:
...
def delete_journal1(request,id):
    if 'username' in request.session:
...
def update_in_exp_items_entry1(request,id):
    if 'username' in request.session:
...
def detailed_journal_report1(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch1/accounts/journal/detailed_journal_report.html', context)
    return render(request, 'index.html')

def journal_report_deleted1(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch1/accounts/journal/journal_report_deleted.html', context)
    return render(request, 'index.html')
...
def daily_category_wise1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/category/daily_category_wise.html',context)
    return render(request, 'index.html')


def monthly_category_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/category/monthly_category_based_reports.html',context)
    return render(request, 'index.html')


def yearly_category_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/category/yearly_category_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_detailed1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/detailed/daily_detailed.html',context)
    return render(request, 'index.html')


def monthly_detailed1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/detailed/monthly_detailed.html',context)
    return render(request, 'index.html')


def yearly_detailed1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/detailed/yearly_detailed.html',context)
    return render(request, 'index.html')
...
def item_based_reports1(request):
    if 'username' in request.session:
...
def daily_item_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/item/daily_item_based_reports.html',context)
    return render(request, 'index.html')



def monthly_item_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/item/monthly_item_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_ledger_based_reports1(request):
    if 'username' in request.session:
...
def ledger_based_reports1(request):
    if 'username' in request.session:
...
def monthly_ledger_based_reports1(request):
    if 'username' in request.session:
...
def accounts_book_based_reports1(request):
    if 'username' in request.session:
...
def daily_accounts_book_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/accounts_book/daily_accounts_book_based_reports.html',context)
    return render(request, 'index.html')



def monthly_accounts_book_based_reports1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_reports/accounts_book/monthly_accounts_book_based_reports.html',context)
    return render(request, 'index.html')
...
def monthly_reports_choose_months1(request):
    if 'username' in request.session:
...
def monthly_detailed_daily_in_exp_items_report1(request,mo):
    if 'username' in request.session:
    ...
    ##****************************************
        ...
        return render(request,'branches/branch1/accounts/monthly_reports/monthly_detailed_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def single_monthly_reports_choose_months1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/monthly_reports/single_monthly_reports_choose_months.html',context)
    return render(request, 'index.html')

def single_monthly_daily_in_exp_items_report1(request,mo):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/monthly_reports/single_monthly_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def accounts_dash_board_ob_ch1(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/accounts_dash_board.html',context)
    return render(request, 'index.html')
...
def accounts_dash_board1(request):
    if 'username' in request.session:
...
def profit_sharing_choose_months1(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request,'branches/branch1/accounts/profit_sharing/profit_sharing_choose_months.html',context)

def profit_sharing1(request,mo):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch1/accounts/profit_sharing/profit_sharing.html',context)
    return render(request, 'index.html')

def view_share_holders1(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch1/accounts/profit_sharing/view_share_holders.html',context)

def create_share_holders1(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch1/accounts/profit_sharing/create_share_holders.html',context)


def regi_share_holders1(request):
    if 'username' in request.session:
        ...
        if tsa <101:
            ...
            return view_share_holders1(request)
...
def regi_multiple_share_holders1(request):
    if 'username' in request.session:
        a=share_holders.objects.all().filter(flag=1)
        tsp=[]
        for i in a:
...
def update_share_holders1(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            name = request.POST.get('name')
            share = request.POST.get('share')
        ...
        return render(request, 'branches/branch1/accounts/profit_sharing/update_share_holders.html',context)

def delete_share_holders1(request,id):
    if 'username' in request.session:
...
def view_deleted_share_holders1(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch1/accounts/profit_sharing/view_deleted_share_holders.html',context)
