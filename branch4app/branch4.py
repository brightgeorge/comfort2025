...
def branch1_dashboard_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        #a = admin_dashboard_calculations_br4.grand_total_collection()
        ...
        context = {
            ...
            #'total_collection_advance': admin_dashboard_calculations_br4.total_collection_advance(),
            #'total_discount': admin_dashboard_calculations_br4.total_discount(),

            #'total_colatable_amount': admin_dashboard_calculations_br4.total_colatable_amount(),
            #'total_collected_amount': admin_dashboard_calculations_br4.total_collected_amount(),
            #'total_due': admin_dashboard_calculations_br4.total_due(),
            #'l': admin_dashboard_calculations_br4.grand_total(),
...
def user_dashboard_calculations_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        a = admin_dashboard_calculations_br4.grand_total_collection()
        from datetime import datetime
    ...
    return render(request, 'branches/branch4/user_dashboard_calculations.html', context)
    return render(request, 'index.html')
...
def admit_guest_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request, 'branches/branch4/new_guest/admit_guest.html',context)


def br1_admit_guest_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_mob == True:
                ...
                return view_all_new_guest_ob_ch4(request)
            else:
                ...
                print('l', l)
                context = {
                    'brname': 'BRANCH4 Room Creation Form',
                    'br': pg1_new_beds.objects.all().filter(roon_no=1).order_by('roon_no'),
                    'rn1': l[0]
                }
...
def multiple_br1_admit_guest4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            selfmob = request.POST.get('selfmobno')
            chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
...
def view_all_new_guest_ob_ch4(request):
    if 'username' in request.session:
...
def update_br1_admit_guest_ob_ch4(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            print('l', l)
            context = {
                'brname': 'BRANCH _ob_ch4 Room Creation Form',
                'br': pg1_new_beds.objects.all().filter(roon_no=1).order_by('roon_no'),
                'rn1': l[0]

            }
            messages.info(request, 'BRANCH_ob_ch4 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return view_all_new_guest_ob_ch4(request)
        else:
            name = request.POST.get('name')
            ...
            messages.info(request, 'BRANCH_ob_ch4 guest updated sucessfully')
            return view_all_new_guest_ob_ch4(request)
...
def vacate_br1_guest_ob_ch4(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRAMCH_ob_ch4 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return view_all_new_guest_ob_ch4(request)
        else:
            ...
            messages.info(request, 'BRANCH_ob_ch4 guest Vacated sucessfully')
            return view_all_new_guest_ob_ch4(request)
...
def active_guest_details_ob_ch4(request,guest_code):
    ...
    return render(request, 'branches/branch4/new_guest/active_guest_details.html', context)




def view_all_guest_ob_ch4(request):
...
def shift_guest_ob_ch4(request,id):
...
def shift_guest_regi_ob_ch4(request):
...
def guest_basic_details(request):
    ...
    return render(request, 'branches/branch4/reports/print/guest_basic_details.html', context)
...
def unpaid_rent_choose_months_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_rent_choose_months.html',context)


def jan_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jan/jan_unpaid_rent.html', context)
def table_jan_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jan/table_jan_unpaid_rent.html', context)


def feb_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/feb/feb_unpaid_rent.html', context)
def table_feb_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/feb/table_feb_unpaid_rent.html', context)


def mar_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/mar/mar_unpaid_rent.html', context)
def table_mar_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/mar/table_mar_unpaid_rent.html', context)


def april_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/apr/april_unpaid_rent.html', context)
def table_april_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/apr/table_april_unpaid_rent.html', context)


def may_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/may/may_unpaid_rent.html', context)
def table_may_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/may/table_may_unpaid_rent.html', context)

def june_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jun/jun_unpaid_rent.html', context)
def table_june_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jun/table_june_unpaid_rent.html', context)

def july_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jul/july_unpaid_rent.html', context)
def table_july_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/jul/table_july_unpaid_rent.html', context)


def aug_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/aug/aug_unpaid_rent.html', context)
def table_aug_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/aug/table_aug_unpaid_rent.html', context)


def sept_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/sep/sept_unpaid_rent.html', context)
def table_sept_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/sep/table_sept_unpaid_rent.html', context)


def oct_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/oct/oct_unpaid_rent.html', context)
def table_oct_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/oct/table_oct_unpaid_rent.html', context)


def nov_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/nov/nov_unpaid_rent.html', context)
def table_nov_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/nov/table_nov_unpaid_rent.html', context)


def dec_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/dec/dec_unpaid_rent.html', context)
def table_dec_unpaid_rent_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/unpaid_rent/unpaid_monthly_reports/dec/table_dec_unpaid_rent.html', context)


# details_of_unpaid_guests start here

def details_of_unpaid_guests_ob_ch4(request, id):
...
def paid_rent_choose_months_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_rent_choose_months.html',context)


def jan_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jan/jan_paid_rent.html', context)
def table_jan_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(jan_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jan/table_jan_paid_rent.html', context)


def feb_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/feb/feb_paid_rent.html', context)
def table_feb_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(feb_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/feb/table_feb_paid_rent.html', context)


def mar_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/mar/mar_paid_rent.html', context)
def table_mar_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(march_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/mar/table_mar_paid_rent.html', context)


def april_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/apr/april_paid_rent.html', context)
def table_april_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(april_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/apr/table_april_paid_rent.html', context)


def may_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/may/may_paid_rent.html', context)
def table_may_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(may_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/may/table_may_paid_rent.html', context)

def june_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jun/june_paid_rent.html', context)
def table_june_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(june_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jun/table_june_paid_rent.html', context)


def july_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jul/july_paid_rent.html', context)
def table_july_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(july_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/jul/table_july_paid_rent.html', context)


def aug_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/aug/aug_paid_rent.html', context)
def table_aug_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(auguest_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/aug/table_aug_paid_rent.html', context)


def sept_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/sep/sept_paid_rent.html', context)
def table_sept_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(sept_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/sep/table_sept_paid_rent.html', context)


def oct_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/oct/oct_paid_rent.html', context)
def table_oct_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(october_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/oct/table_oct_paid_rent.html', context)


def nov_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/nov/nov_paid_rent.html', context)
def table_nov_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(nov_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/nov/table_nov_paid_rent.html', context)


def dec_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/dec/dec_paid_rent.html', context)
def table_dec_paid_rent_ob_ch4(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(dec_rent_flag=200, flag=2)
        for i in unp:
        ...
        return render(request, 'branches/branch4/reports/paid_rent/paid_monthly_reports/dec/table_dec_paid_rent.html', context)
...
def details_of_paid_guests_ob_ch4(request, id):
    rno = pg1_new_guest.objects.all().filter(id=id)
    l = []
    for i in rno:
        l.append(str(i.roon_no))
...
def choose_months_ob_ch4(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch4/payments/choose_months.html',context)

#jan make payments start here
def jan_ob_ch4(request):
    if 'username' in request.session:
...
def jan_manke_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            import branch4app
            jp = branch4app.models.pg1_new_beds.objects.get(guest_code=l[0])
            jp.jan_rent = amt
            jp.jan_dis_amt = dis_amt
            jp.jan_due_amt = due_amt
            jp.remark = remark
        ...
        import branch4app
        total_discout_amt = []
        pg1_new_beds = branch4app.models.pg1_new_guest.objects.all().filter(flag=2, guest_code=l[0])
...
def feb_manke_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_manke_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def july_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def aug_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def oct_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_make_payments_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def choose_months_advance_ob_ch4(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch4/advance/choose_months_advance.html',context)


def jan_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def jan_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch4/advance/details_of_months/jan/jan_make_payments_advance.html', context)
    return render(request, 'index.html')


def feb_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def feb_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def march_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def april_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def may_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def june_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch4/advance/details_of_months/june/june_make_payments_advance.html',context)
    return render(request, 'index.html')


def july_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def july_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def auguest_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def auguest_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def sept_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def october_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def october_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def nov_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_advance_ob_ch4(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def dec_make_payments_advance_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def detail_guest_general_ob_ch4(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def jan_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            ...
            bc = branch_closing.objects.get(branch_name='branch_ob_ch4')
            bc.jan = 1
            bc.save()
            return feb_print_ob_ch4(request)

    return render(request, 'index.html')


def jan_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def feb_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.feb = 1
            bc.save()
            return march_print_ob_ch4(request)

    return render(request, 'index.html')


def feb_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def march_print_ob_ch4(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def mar_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch_ob_ch4').exists()
        ...
        if chk == True:
            ...
            bc.mar = 1
            bc.save()
            return april_print_ob_ch4(request)
    return render(request, 'index.html')


def mar_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def april_print_ob_ch4(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def apr_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.apr = 1
            bc.save()
            return may_print_ob_ch4(request)
    return render(request, 'index.html')


def apr_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def may_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.may = 1
            bc.save()
            return june_print_ob_ch4(request)
    return render(request, 'index.html')


def may_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def jun_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jun = 1
            bc.save()
            return july_print_ob_ch4(request)
    return render(request, 'index.html')


def jun_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def jul_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jul = 1
            bc.save()
            return aug_print_ob_ch4(request)
    return render(request, 'index.html')


def jul_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def aug_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.aug = 1
            bc.save()
            return sept_print_ob_ch4(request)
    return render(request, 'index.html')


def aug_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def sep_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch_ob_ch4').exists()
        ...
        if chk == True:
            ...
            bc.sep = 1
            bc.save()
            return oct_print_ob_ch4(request)
    return render(request, 'index.html')


def sep_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def oct_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.oct = 1
            bc.save()
            return nov_print_ob_ch4(request)
    return render(request, 'index.html')


def oct_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def nov_close_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.nov = 1
            bc.save()
            return dec_print_ob_ch4(request)
    return render(request, 'index.html')


def nov_close_decision_page_ob_ch4(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch_ob_ch4').exists()
        print(chk)
        if chk == True:
...
def new_year_jan_print_ob_ch4(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
        ...
        return render(request, 'branches/branch4/print_outs/new_year_jan_print.html', context)
    return render(request, 'index.html')
...
def viewall_vacate_guest_ob_ch4(request):
...
def details_of_vacate_guest_ob_ch4(request, id):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def full_vacated_guest_details_ob_ch4(request):
    ...
    return render(request, 'branches/branch4/vacate_guest/full_vacated_guest_details.html', context)


def full_vacated_guest_table_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request, 'branches/branch4/vacate_guest/full_vacated_guest_table.html', context)


# ***********vacate guest payments start here*******

def jan_manke_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        import branch4app
        total_discout_amt = []
        pg1_new_beds = branch4app.models.pg1_new_guest.objects.all().filter(flag=3, guest_code=l[0])
        for i in pg1_new_beds:
            total_discout_amt.append(int(i.jan_dis_amt))
        ...
        return render(request, 'branches/branch4/payments/details_of_months/jan/jan_manke_payments_vacate.html',context)


def feb_manke_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch4/payments/details_of_months/feb/feb_manke_payments_vacate.html',context)


def march_manke_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch4/payments/details_of_months/march/march_manke_payments_vacate.html',context)


def april_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/april/april_make_payments_vacate.html',context)


def may_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/may/may_make_payments_vacate.html',context)


def june_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/june/june_make_payments_vacate.html',context)


def july_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/july/july_make_payments_vacate.html',context)


def aug_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/aug/aug_make_payments_vacate.html',context)


def sept_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/sept/sept_make_payments_vacate.html',context)


def oct_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/oct/oct_make_payments_vacate.html',context)


def nov_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch4/vacate_guest/vacate_payments/details_of_months/nov/nov_make_payments_vacate.html',context)


def dec_make_payments_vacate_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def view_all_due_amt_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request, 'branches/branch4/due_amt_mgt/view_all_due_amt.html',context)

def due_amt_mgt_choose_months_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request, 'branches/branch4/due_amt_mgt/due_amt_mgt_choose_months.html',context)


def view_jan_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/jan/view_jan_account_details.html',context)
def jan_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.jan_rent_flag = chk
            ic.save()
            return view_jan_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/jan/jan_account_mgt.html',context)


def view_feb_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/feb/view_feb_account_details.html',context)
def feb_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.feb_rent_flag = chk
            ic.save()
            return view_feb_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/feb/feb_account_mgt.html',context)


def view_march_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/march/view_march_account_details.html',context)
def march_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.march_rent_flag = chk
            ic.save()
            return view_march_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/march/march_account_mgt.html',context)


def view_april_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/april/view_april_account_details.html',context)
def april_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.april_rent_flag = chk
            ic.save()
            return view_april_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/april/april_account_mgt.html',context)


def view_may_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def may_account_mgt_ob_ch4(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.may_rent_flag = chk
            ic.save()
            return view_may_account_details_ob_ch4(request)
...
def view_june_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/june/view_june_account_details.html',context)
def june_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.june_rent_flag = chk
            ic.save()
            return view_june_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/june/june_account_mgt.html',context)


def view_july_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/july/view_july_account_details.html',context)
def july_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.july_rent_flag = chk
            ic.save()
            return view_july_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/july/july_account_mgt.html',context)


def view_auguest_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/auguest/view_auguest_account_details.html',context)
def auguest_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.auguest_rent_flag = chk
            ic.save()
            return view_auguest_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/auguest/auguest_account_mgt.html',context)


def view_sept_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/sept/view_sept_account_details.html',context)
def sept_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.sept_rent_flag = chk
            ic.save()
            return view_sept_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/sept/sept_account_mgt.html',context)


def view_october_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/october/view_october_account_details.html',context)
def october_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.october_rent_flag = chk
            ic.save()
            return view_october_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/october/october_account_mgt.html',context)


def view_nov_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/nov/view_nov_account_details.html',context)
def nov_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.nov_rent_flag = chk
            ic.save()
            return view_nov_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/nov/nov_account_mgt.html',context)


def view_dec_account_details_ob_ch4(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
    ...
    return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/dec/view_dec_account_details.html',context)
def dec_account_mgt_ob_ch4(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.dec_rent_flag = chk
            ic.save()
            return view_dec_account_details_ob_ch4(request)
        ...
        return render(request,'branches/branch4/due_amt_mgt/monthly_detailes_due_amt/dec/dec_account_mgt.html',context)
...
def manage_new_guest_ob_ch4(request):
    if 'username' in request.session:
...
def manage_update_new_guest_ob_ch4(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRANCH_ob_ch4 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return manage_new_guest_ob_ch4(request)
        else:
            name = request.POST.get('name')
...
def manage_update_new_guest_ob_ch4_test(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
...
def manage_update_beds_ob_ch4(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRANCH_ob_ch4 guest updated sucessfully')
            return manage_bed_ob_ch4(request)
...
def pysql(request):
    ...
    return branch1_dashboard_ob_ch4 (request)
...
def dynamic(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'mt2':'page five _ob_ch4 dynamic code',
...
def background_ob_ch4(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch4/test/background.html', context)
    return render(request, 'index.html')

def background_regi_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
...
def custom_background_regi_ob_ch4(request):
    if 'username' in request.session:
        us = request.session['username']
        th = request.POST.get('theme')
        uc=background_color.objects.all().filter(username=us).exists()
...
def update_all_rent_ob_ch4(request):
    z=10
    if z==10:
        r=6000
        l=[]
